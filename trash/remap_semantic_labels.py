...
if __name__ == '__main__':
  ...
  for label_file in tqdm(label_names):
    ...
    if lower_half.max() > 19:
        print()
        print('It has already been mapped. Skip everything in this folder. (' + FLAGS.label_folder + ')')
        print()
        break
    if (lower_half == 0).all():
        print()
        print('It has already been mapped more than once. Skip everything in this folder. (' + FLAGS.label_folder + ')')
        print()
        break
